...
function HomePage() {
  ...
  const handleClick = () => {
    window.open(
      "https://github.com/Azeemahma/Apna-Resume",
      "_blank"
    );
  };
  ...
  return (
    <>
      <Header user={user} />
      <section className="pt-24 pb-20 bg-gradient-to-r from-teal-500 to-blue-600">
        <div className="px-12 mx-auto max-w-7xl">
          <div className="w-full mx-auto text-left md:w-11/12 xl:w-9/12 md:text-center">
            ...
            <p className="px-0 mb-8 text-2xl text-gray-200 md:text-3xl lg:px-24">
              AI Resumes Made Easy
            </p>
      ...
      <footer className="bg-gradient-to-r from-teal-500 to-blue-600" aria-labelledby="footer-heading">
        <div className="p-5 flex justify-center">
          <p className="text-xs leading-5 text-white">
            &copy; 2025 Apna Resume. All rights reserved.
          </p>
        </div>
      </footer>
    </>
